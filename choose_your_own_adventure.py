...
if answer == "left":
    ...
    answer = input(
        "You come to a bridge, it looks wobbly, do you want to across it or head back (cross/back)?").lower()
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print("You talk to the stranger and they have give you gold. YOU WIN!")
        elif answer == "no":
